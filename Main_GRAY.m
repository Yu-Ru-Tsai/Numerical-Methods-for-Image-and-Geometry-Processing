...
for model_num = 1 : length(model_name)
    ...
    if strcmp(model_name(model_num), "1-Norm") || strcmp(model_name(model_num), "Isotropic") ...
        ...
        img_denoised(model_num, :,:) = WhichModel(model_name(model_num), img_noisy_temp, linear_solver_method, lambda,  mu, 0, ...
    ...
    elseif strcmp(model_name(model_num), "2-Norm") || strcmp(model_name(model_num), "1->2-Norm")
        ...
        img_denoised(model_num, :,:) = WhichModel(model_name(model_num), img_noisy_temp, linear_solver_method, 0, mu, 0, ...
    ...
    elseif strcmp(model_name(model_num), "1&2-Norm")
        ...
        img_denoised(model_num, :,:) = WhichModel(model_name(model_num), img_noisy, linear_solver_method, lambda, mu, alpha, ...
            OUTER_MIN_ITER, OUTER_MAX_ITER, OUTER_TOL, OUTER_ERROR, INNER_MAX_ITER, INNER_TOL);
...
result_name = append('result/', name, '_', upper(string(noise_type)), '_GRAY.png');
