function PlotResultGRAY(img_origin, img_noisy, noise_type, img_denoised, result_name, optimal_parameters)

[img_size_h, img_size_w] = size(img_noisy);
img_denoised_1  = reshape(img_denoised(1,:,:), [img_size_h, img_size_w]);
img_denoised_I  = reshape(img_denoised(2,:,:), [img_size_h, img_size_w]);
img_denoised_A  = reshape(img_denoised(3,:,:), [img_size_h, img_size_w]);
img_denoised_2  = reshape(img_denoised(4,:,:), [img_size_h, img_size_w]);
img_denoised_12 = reshape(img_denoised(5,:,:), [img_size_h, img_size_w]);
img_denoised_1then2 = reshape(img_denoised(6,:,:), [img_size_h, img_size_w]);
img_denoised_2then1 = reshape(img_denoised(7,:,:), [img_size_h, img_size_w]);
...
title({'1-norm TV model' ...
    ['\lambda = ', num2str(optimal_parameters(1,1), format_spec), ', \mu = ', num2str(optimal_parameters(1,2), format_spec)] ...
...
title({'Isotropic TV model' ...
    ['\lambda = ', num2str(optimal_parameters(2,1), format_spec), ', \mu = ', num2str(optimal_parameters(2,2), format_spec)] ...
...
title({'Anisotropic TV model' ...
    ['\lambda = ', num2str(optimal_parameters(3,1), format_spec), ', \mu = ', num2str(optimal_parameters(3,2), format_spec)] ...
...
title({'2-norm TV model' ...
    ['\mu = ', num2str(optimal_parameters(4,2), format_spec)] ...
...
title({'1 & 2-norm TV model' ...
    ['\lambda = ', num2str(optimal_parameters(5,1), format_spec), ', \mu = ', num2str(optimal_parameters(5,2), format_spec), ', \alpha = ', num2str(optimal_parameters(5,3), format_spec)] ...
...
axis off;
title({'1 -> 2-norm TV model' ...
    ['\mu = ', num2str(optimal_parameters(6,2), format_spec)] ...
...
title({'2 -> 1-norm TV model' ...
    ['\lambda = ', num2str(optimal_parameters(7,1), format_spec), ', \mu = ', num2str(optimal_parameters(7,2), format_spec)] ...
